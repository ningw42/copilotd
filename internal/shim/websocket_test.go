...
func TestWebSocketAdaptersAreNilWithoutDirectionalParticipants(t *testing.T) {
	...
	if adapter := chain.WSClientAdapter(nil, context.Background()); adapter != nil {
		t.Errorf("WSClientAdapter() = %T, want nil", adapter)
	}
	if adapter := chain.WSServerAdapter(nil, context.Background()); adapter != nil {
...
func TestWSClientAdapterFoldsParticipantsInRegistrationOrder(t *testing.T) {
	...
	adapter := registry.NewChain(context.Background(), endpoint.OpenAI, endpoint.RouteOpenAIResponses).WSClientAdapter(nil, context.Background())
	if adapter == nil {
...
func TestWSServerAdapterFoldsParticipantsInReverseRegistrationOrder(t *testing.T) {
	...
	adapter := registry.NewChain(context.Background(), endpoint.OpenAI, endpoint.RouteOpenAIResponses).WSServerAdapter(nil, context.Background())
	if adapter == nil {
