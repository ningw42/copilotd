...
and SSE OpenAI Responses** completions. Anthropic SSE and OpenAI WebSocket
...
| Inference shims | `internal/shim` | Ordered hook contract for opt-in parity transforms and read-only observers, including the Responses item-id stabilizer, buffered Usage meter observers for both inference Surfaces, and OpenAI SSE completion observation |
